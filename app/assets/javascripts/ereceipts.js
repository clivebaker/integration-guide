...
(function ($, root) {
  ...
  try {
    // Foundation calls on Modernizr alot, if this variable is undefined then
    // an error will be thrown and foundation may not function correctly.
...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    root.prl.components.navigation = factory();
  }
  ...
  return function () {
    var selector = ".prl-navigation .prl-navigation-caret";
    $(selector).on("click", "a", function (event) {
      event.preventDefault();
      $(this).closest(".prl-navigation").toggleClass("is-open");
    });
  };
